...
function program7(depth0,data) {
  ...
  buffer += "\n    </tbody>     \n  </table>\n</div>\n";
  return buffer;});
templates['edit-test.tmpl'] = template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<div class=\"container-fluid\">\n  <div class=\"row-fluid\">\n  	Input:\n    <textarea id=\"input\" rows=\"8\"></textarea>\n\n    <br />\n\n    Expected output:\n    <textarea id=\"expected-output\" rows=\"8\"></textarea>\n\n    <br />\n\n    <button class=\"btn\" id=\"testcase-discard\">\n      Discard\n    </button>\n\n    <button class=\"btn btn-primary\" id=\"testcase-save\">\n      Save\n    </button>\n\n  </div>\n</div>";});
